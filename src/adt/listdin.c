...
/* Mengirimkan indeks elemen l terakhir */
{
    ...
    /* ALGORITMA */
    return (IdxType) (listLength(l) - 1); /*  Tetapi menurut definisi header: indeks yang digunakan [0..capacity-1] */ /* Ini masih diragukan*/
}
...
/* Jika plus = false, mengirimkan l1-l2, yaitu setiap elemen l1 dikurangi elemen l2 pada indeks yang sama */
{
    ...
    /* ALGORITMA */
    CreateListDin(&l, listLength(l1)); /* listLength(l1) == listLength(l2) */
